...
$(document).ready(function () {
    ...
    add_normal("<a target='_blank' href='newspaper/'>Click here to view my academic skillset.</a>");
    add_normal("");
    ...
    add_normal("<a target='_blank' href='code/'>Click here to see my life as a coder, minus the coffee.</a>")
