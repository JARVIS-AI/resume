...
$(document).ready(function () {
    ...
    add("I'm currently an MEng Computing student at Imperial College London.")
    add_normal('')
    add("Outside of school, I'm a startup founder!")
    add_normal('I founded <a href="https://helloaiko.com" target="_blank">Aiko AI</a> and <a href="http://glemeapp.com">Gleme</a>.')
    add_normal("");
    ...
    add_normal("<a target='_blank' href='https://www.devpost.com/priansh'>Here are some selected projects.</a>")
    add_normal("<a target='_blank' href='https://www.github.com/pshah123'>And here are all the projects that I've open sourced!</a>")
    add_normal("")
